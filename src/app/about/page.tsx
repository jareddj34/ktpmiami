            ...
            <div className="relative bg-gray-50 py-8 sm:py-16">
                <div className="mx-auto max-w-md px-6 text-center sm:max-w-3xl lg:max-w-7xl lg:px-8">
                    ...
                    {/* <div className="grid grid-cols-1 md:grid-cols-3 gap-y-4 md:gap-x-4 py-6">
                        <div className="overflow-hidden h-fit rounded-lg border border-gray-200 order-first md:order-last shadow-lg sm:hover:shadow-xl transition-shadow border transition bg-gray-100 px-6 pb-8 sm:transition-all sm:duration-300 sm:ease-in-out sm:hover:scale-110 sm:transform">
                            <div className="-mt-6">
                                <div>
                                    <span className="inline-flex items-center justify-center rounded-xl bg-green-700 p-2 shadow-lg">
                                        <svg
                                ...
                                <p className="mt-5 text-base leading-7 text-gray-600">
                                    Through events like interview training,
                                    resume building, one-on-one mentorship,
                                    private company recruiting, and more, Kappa
                                    Theta Pi Professional Development aims to
                                    prepare members for success in any
                                    technology-related career. We take pride in
                                    developing the tech leaders of the future.
                                </p>
                            </div>
                        </div>
                        <div className="overflow-hidden h-fit rounded-lg border border-gray-200 order-first md:order-last shadow-lg sm:hover:shadow-xl transition-shadow border transition bg-gray-100 px-6 pb-8 sm:transition-all sm:duration-300 sm:ease-in-out sm:hover:scale-110 sm:transform">
 ...
 */}
                    ...
                    {/* <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3 pt-6">
                        <div className="h-[20rem] sm:h-[10rem] lg:h-[23rem] h-fill flow-root rounded-2xl shadow-lg sm:hover:shadow-xl transition-shadow border transition bg-gray-100 px-6 pb-8 sm:transition-all sm:duration-300 sm:ease-in-out sm:hover:scale-110 sm:transform">
                            <div className="-mt-6">
                                <div>
                                    <span className="inline-flex items-center justify-center rounded-xl bg-green-700 p-2 shadow-lg">
                                        <svg
                        ...
                        <div className="h-[20rem] sm:h-[10rem] lg:h-[23rem] h-fill flow-root rounded-2xl shadow-lg sm:hover:shadow-xl transition-shadow border transition bg-gray-100 px-6 pb-8 sm:transition-all sm:duration-300 sm:ease-in-out sm:hover:scale-110 sm:transform">
                            <div className="-mt-6">
                                ...
                                <p className="mt-5 text-base leading-7 text-gray-600">
                                    Our alumni are spread out across the world
                                    and work on cutting-edge technologies. They
                                    work at a plethora of companies - from tech
                                    companies like Microsoft, Amazon, Facebook,
                                    Apple, and Google, to startups, consulting
                                    firms, financial technology firms, and more!
                                </p>
                            </div>
                        </div>
                        <div className="h-[20rem] sm:h-[10rem] lg:h-[23rem] h-fill flow-root rounded-2xl shadow-lg sm:hover:shadow-xl transition-shadow border transition bg-gray-100 px-6 pb-8 sm:transition-all sm:duration-300 sm:ease-in-out sm:hover:scale-110 sm:transform">
                            <div className="-mt-6">
                                ...
                                <p className="mt-5 text-base leading-7 text-gray-600">
                                    The people you meet in Kappa Theta Pi will
                                    go on to be some of your closest friends
                                    throughout college and beyond. We host a
                                    variety of exclusive social events
                                    throughout the semester through which our
                                    members can bond, some of which include
                                    formal, tailgates, retreat, and apple
                                    picking.
                                </p>
                            </div>
                        </div>
                        <div className="w-[35rem] h-[20rem] sm:h-[10rem] lg:h-[18rem] h-fill flow-root rounded-2xl shadow-lg sm:hover:shadow-xl transition-shadow border transition bg-gray-100 px-6 pb-8 sm:transition-all sm:duration-300 sm:ease-in-out sm:hover:scale-110 sm:transform">
                            <div className="-mt-6">
                                <div>
                                    <span className="inline-flex items-center justify-center rounded-xl bg-green-700 p-2 shadow-lg">
                                        <svg
                                ...
                                <p className="mt-5 text-base leading-7 text-gray-600">
                                    Kappa Theta Pi provides members numerous
                                    opportunities to enhance their current
                                    technical skills, as well as learn new ones.
                                    Whether it be participation in one of our
                                    various project teams or attending a
                                    technical workshop, we make it easy for our
                                    members to expand their expertise.
                                </p>
                            </div>
                        </div>
                        <div></div>
                        <div
                            className="relative w-[35rem] h-[20rem] sm:h-[10rem] lg:h-[18rem] h-fill flow-root rounded-2xl shadow-lg sm:hover:shadow-xl transition-shadow border transition bg-gray-100 px-6 pb-8 sm:transition-all sm:duration-300 sm:ease-in-out sm:hover:scale-110 sm:transform"
                            style={{ left: "-58%" }}
                        >
                            <div className="-mt-6">
                                <div>
                                ...
                                <p className="mt-5 text-base leading-7 text-gray-600">
                                    ...
                                    academic growth and excellence for each
                                    other. We provide a supportive network
                                    filled with some of the brightest tech minds
                                    at the university that members can always
                                    rely on for help in classes and
