        ...
        <>
            <div className="flex">
                <div className="mt-40 w-2/3 pr-10">
                    <h1 className="flex justify-left text-7xl mt-4 font-bold">
                        Kappa Theta Pi
                    </h1>
                ...
                <div className="flex">
                    ...
                    <div className="mr-auto w-44 flex-none space-y-8 sm:mr-0 sm:pt-52 lg:pt-36 ml-10">
                        <div className="relative">
                            <img
                                src="/images/UMiamiLogo.jpg"
                                height={128}
                    ...
                    <div className="mr-auto w-44 flex-none space-y-8 sm:mr-0 sm:pt-52 lg:pt-36 ml-10 mt-10">
                        <div className="relative">
                            <img
                                src="/images/UMiamiLogo.jpg"
                                height={128}
